...
class FacilitiesControllerTest < ActionController::TestCase
  ...
  test "should create facility" do
    assert_difference('Facility.count') do
      post :create, facility: { city: @facility.city, description: @facility.description, name: @facility.name, state: @facility.state, zip: @facility.zip }
    end
  ...
  test "should update facility" do
    patch :update, id: @facility, facility: { city: @facility.city, description: @facility.description, name: @facility.name, state: @facility.state, zip: @facility.zip }
    assert_redirected_to facility_path(assigns(:facility))
  end
